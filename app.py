...
# 2. كود الـ CSS المخصص لمحاكاة تصميم الواجهة في الصورة بالكامل
siteonic_style_css = """
<style>
/* إخفاء العناصر الافتراضية من Streamlit */
...
/* أماكن البطاقات بالتحديد مثل الصورة */
...
<div class="hero-wrapper">
    ...
    <div class="hero-content">
        ...
        <div class="hero-description">
            انضموا إلى منصتنا المتكاملة واحصلوا على جميع الأدوات الذكية التي تحتاجهونها لإدارة الموارد، الاستثمارات، والتحليلات بنجاح.
        </div>
    ...
    <!-- البطاقات العائمة الشفافة (الشمال) -->
...
st.markdown(hero_html, unsafe_allow_html=True)        border-right: 1px solid #30363d !important;
    }
