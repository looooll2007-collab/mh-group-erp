...
if not st.session_state["logged_in"]:
    ...
    # ==========================================
    # 📊 اللوحة التنفيذية (المحدثة لتعرض البيانات لحظياً)
    # ==========================================
    if selected_page == "📊 لوحة التحليلات التنفيذية":
        ...
        # التبويبات (هنا التعديل الجوهري: البيانات تُقرأ داخل التبويب)
